...
- $\large \Delta x = v_{i}t + \frac{1}{2}at^{2}$
- $\large v_{f} = v_{i} + at$
- $\large v_{f}^{2} = v_{i}^{2} +2a\Delta x$
...
$\large t = \frac{\ell}{v_i} = \frac{0.2}{1{,}000{,}000} = 2 \times 10^{-7} \, \text{s}$  

$\large F = qE = (1.6 \times 10^{-19})(300) = 4.8 \times 10^{-17} \, \text{N}$  

$\large a = \frac{F}{m} = \frac{4.8 \times 10^{-17}}{9.11 \times 10^{-31}} = 5.27 \times 10^{13} \, \text{m/s}^2$  

$\large \Delta y = \frac{1}{2} a t^2 = \frac{1}{2}(5.27 \times 10^{13})(2 \times 10^{-7})^2$  

$\large \Delta y = \frac{1}{2}(5.27 \times 10^{13})(4 \times 10^{-14})$  

$\large \Delta y = (2 \times 10^{-14})(5.27 \times 10^{13}) = 1.05 \, \text{m}$
:::
